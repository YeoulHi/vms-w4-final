...
![screenshot of the deployed Django project](https://res.cloudinary.com/railway/image/upload/v1729121823/docs/quick-start/django_app.png)
...
![screenshot of the deploy architecture of the Django app](https://res.cloudinary.com/railway/image/upload/v1731604331/docs/quick-start/deployed_django_app_architecture.png)
...
![screenshot of the deploy architecture of the Django app](https://res.cloudinary.com/railway/image/upload/f_auto,q_auto/v1731604331/docs/quick-start/deployed_django_app_architecture.png)

*   **Cron Service**: This service should run Celery Beat Scheduler to manage scheduled tasks.

![screenshot of the cron service of the Django app](https://res.cloudinary.com/railway/image/upload/f_auto,q_auto/v1731605926/docs/quick-start/django_cron_service.png)

*   **Worker Service**: This service should be running Celery and ready to process jobs from the queue.

![screenshot of the worker service of the Django app](https://res.cloudinary.com/railway/image/upload/f_auto,q_auto/v1731605981/docs/quick-start/django_worker_service.png)
